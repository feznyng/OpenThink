...
export default function FeaturedOrganizations() {
  const featuredSpaceIds = JSON.parse(
    process.env.REACT_APP_FEATURED_ORGANIZATION_IDS,
        ...
        <div style={{ maxWidth: 700, textAlign: "center" }}>
          ...
          <div style={{ marginTop: 20, marginBottom: 20 }}>
            <Typography variant="body2" style={{ fontSize: 20 }}>
              We help organizations across the world connect with volunteers and
              get organized with our project management and collaboration tools.
            </Typography>
          </div>
          <div>
            <Button
