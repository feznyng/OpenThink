...
export default function PostView({
  ...
  hideImageButtons =
    hideImageButtons || !!(!onBannerChange && (!onIconChange || icon));
    ...
    <div style={{ ...style, width: "100%" }}>
      ...
      >
        {!readonly && !hideImageButtons && (
          ...
          >
            <Fade in={!!state.hover || state.anchorEl}>
      ...
      {attributes && attributeValues && !hideAttributes && (
        <AttributeTable
          ...
          changeAttributeValue={(attribute, value) =>
            onAttributeChange && onAttributeChange(attribute.name, value)
          }
        />
      )}
      <PostContentEditor
