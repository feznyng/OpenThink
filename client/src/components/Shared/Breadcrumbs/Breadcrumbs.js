...
const Breadcrumbs = React.forwardRef(function Breadcrumbs(props, ref) {
  ...
  const renderItemsBeforeAndAfter = (allItems) => {
    ...
    return [
      ...
      <BreadcrumbCollapsed aria-label={expandText} key="ellipsis" onClick={handleClickExpand} items={allItems.slice(itemsBeforeCollapse, allItems.length - (itemsAfterCollapse + 1))}/>,
